//Code changed and Updated By
//https://ThoughtGem.Online
...
$(document).ready(function() {
	...
	$("#btnPrint").click(function(){
		  var divContents = $("#contentArea").html();
            var printWindow = window.open('', '', 'height=auto,width=800');
            printWindow.document.write('<html><head><title>'+$('#header').val()+'</title>');
            printWindow.document.write("<link rel='stylesheet' type='text/css' href='css/style.css' />");
			printWindow.document.write("<link rel='stylesheet' type='text/css' href='css/print.css' media='print' /></head><body >");
			printWindow.document.write("<body style='pointer-events:none;' >");
            printWindow.document.write(divContents);
            printWindow.document.write('</body></html>');
            printWindow.document.close();
			setTimeout(function(){
            printWindow.print();},1000);
